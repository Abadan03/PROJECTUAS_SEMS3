...
<html lang="en">
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="container">
      ...
      <h1 class="display-4">Jadwal Yang Tersedia</h1>
  ...
  <div class="container">
      ...
      <div class="col-lg form-pemesanan">
        ...
        <div class="table-responsive-md">
          <div class="form-outline">
            <input type="search" class="form-control" placeholder="Cari Tujuan Anda" id="live_search"/>
          </div>
          <div id="searchresult" name="searchresult" class="mt-5 table-responsive">
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- <script type="text/javascript"
      ...
      data-client-key="SB-Mid-client-47Mb1kvUCsl453Fi"></script> -->
